      ...
      <div className="flex-1 flex flex-col justify-between py-1 pr-2">
        <div>
          ...
          <div className="relative mb-4">
            ...
            <p className="font-body text-lg leading-relaxed text-foreground line-clamp-4 relative z-10 pl-2">
              "{review.text}"
            </p>
          </div>
        </div>
        <div className="pt-3 border-t border-border/40 flex items-center justify-between">
          ...
          {review.itineraryName && (
            <div className="text-xs text-muted-foreground font-medium text-right max-w-[120px] truncate" style={{ fontFamily: "'DM Sans', sans-serif" }}>
              Verified Booking <br />
